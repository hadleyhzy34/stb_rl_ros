...
import string
from stable_baselines3 import TD3_BC
from stable_baselines3.common.logger import configure
from agent.feature_extractor import CustomFeature
...
def train(args):
    ...
    policy_kwargs = dict(
        features_extractor_class = CustomFeature,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rank_update_interval', type=int, default=100)
